    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white flex flex-col items-center justify-center px-6 max-w-[480px] mx-auto">
      ...
      <div className="text-center mb-10">
        <div className="text-5xl mb-3">
          <svg
            className="inline-block w-14 h-14 text-green-500"
            viewBox="0 0 48 48"
            fill="none"
          ...
          >
            {/* Sparkle */}
            <path
              d="M24 4l2.5 7.5L34 14l-7.5 2.5L24 24l-2.5-7.5L14 14l7.5-2.5L24 4z"
              fill="currentColor"
              opacity="0.8"
            />
            <path
              d="M36 20l1.5 4.5L42 26l-4.5 1.5L36 32l-1.5-4.5L30 26l4.5-1.5L36 20z"
              fill="currentColor"
              opacity="0.5"
            />
            {/* Broom handle */}
            ...
            {/* Broom head */}
            <path
              d="M26 28l6-6c1-1 3-1 4 0l0 0c1 1 1 3 0 4l-6 6-4-4z"
              fill="currentColor"
            />
          </svg>
        </div>
