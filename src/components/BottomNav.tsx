...
export default function BottomNav() {
  ...
  const role = (localStorage.getItem('cleanmatch_role') as UserRole) || 'client';
  ...
  const items: NavItem[] = [
    {
      ...
      path: role === 'cleaner' ? '/clean/cleaner' : '/clean/client',
    },
    {
      label: '의뢰',
      icon: (
      ...
      path: role === 'cleaner' ? '/clean/cleaner' : '/clean/client/create',
    },
    {
      label: '채팅',
      icon: (
