      ...
      <div className="p-4 space-y-4">
        <div className="bg-white rounded-xl p-4 shadow-sm border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-gray-800">{role === 'client' ? '의뢰자' : '청소자'}</p>
...
function BottomNavInline() {
  ...
  const tabs = [
    { label: '홈', path: role === 'client' ? '/clean/client' : '/clean/cleaner',
    ...
    { label: '의뢰', path: role === 'client' ? '/clean/client/create' : '/clean/cleaner',
